...
# Only export module members when this file is imported as a module (.psm1)
# When dot-sourced as a plain script, Export-ModuleMember will throw the
# "can only be called from inside a module" error. Guard it here.
